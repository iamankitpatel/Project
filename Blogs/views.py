...
def Home(request):
    ...
    if request.method == 'POST':
        ...
        from_email = 'Blogify <blogify.csit@gmail.com>'
        user_email = email
...
def ContactUs(request):
    if request.method == 'POST':
        ...
        admin_email = 'Blogify <blogify.csit@gmail.com>'
...
def RequestYourTopic(request):
    if request.method == 'POST':
        ...
        req.save()
    return render(request, "request-your-topic.html")    
...
def StartPosting(request):
    if request.method == 'POST':
        ...
        post = Post(title=title, category=category, date=date, featured_image=featured_image, body=body)
        post.save()
